...
{if isset($products) && $products}
	...
	{/if}
	{if isset($themeSetting.list_style) && $themeSetting.list_style|count_characters > 0 && $themeSetting.list_style != 'default'}
		{include file="./product-list-{$themeSetting.list_style}.tpl" products=$products themeSetting=$themeSetting}
	{else}
		...
		{/if}
			{foreach from=$products item=product name=products}
				...
				{foreach from=$imginfo item=imgitem}
					...
					{/if}
				{/foreach}
				<div itemscope itemtype="http://schema.org/Product" class="product-item ajax_block_product style1 {$liwidth} {if isset($itemClass)} {$itemClass}{/if}">
