...
<div class="head">
	<h3 class="title">{l s='Newsletter' mod='blocknewsletter'}</h3>
...
<div class="col-lg-offset-2 col-sm-12 col-lg-8">
	<div class="block-newletter style3">
		<div class="form">
			<div class="desc">
				<span class="text-primary">{l s='Get' mod='blocknewsletter'}<span class="big-text">{l s='30%' mod='blocknewsletter'}</span> {l s='off' mod='blocknewsletter'}</span>
