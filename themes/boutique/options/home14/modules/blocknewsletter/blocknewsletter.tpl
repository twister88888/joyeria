...
<div class="widget widget_newletter">
	<h3 class="widget-title">{l s='Newsletter' mod='blocknewsletter'}</h3>
	<p>{l s='Lorem Ipsum is simply dummy text of the printing and typesetting.' mod='blocknewsletter'}</p>
