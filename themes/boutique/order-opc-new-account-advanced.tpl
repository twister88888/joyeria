        ...
        <fieldset>
            ...
            <div id="login_form_content" style="display:none;">
                ...
                <p class="submit">
                    ...
                    <button type="submit" id="SubmitLogin" name="SubmitLogin" data-adv-api="1" class="button btn btn-default button-medium"><span><i class="fa fa-lock left"></i>{l s='Sign in'}</span></button>
                </p>
            </div>
        </fieldset>
    </form>
            ...
            <div class="box">
                ...
                <div id="opc_account_form" class="unvisible">
                    ...
                    <div class="submit opc-add-save clearfix">
                        ...
                        <button type="submit" name="submitAccount" id="submitAccount" data-adv-api="1" class="btn btn-default button button-medium"><span>{l s='Save'}<i class="fa fa-chevron-right right"></i></span></button>
