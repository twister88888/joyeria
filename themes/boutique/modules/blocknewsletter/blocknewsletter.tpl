	...
	<div class="col-sm-12 col-md-5">
		<div class="newsletter">
			...
			<form class="form-newsletter" action="{$link->getPageLink('index', null, null, null, false, null, true)|escape:'html':'UTF-8'}" method="post">
				<input class="inputNew form-control newsletter-input" id="newsletter-input" type="text" name="email" size="18" value="{if isset($msg) && $msg}{$msg}{elseif isset($value) && $value}{$value}{else}{l s='Your email address here...' mod='blocknewsletter'}{/if}" />
				<span><button type="submit" name="submitNewsletter" class="newsletter-submit">
...
{/if}
<div class="hidden">
	{l s='Your email...' mod='blocknewsletter'}
	{l s='OK' mod='blocknewsletter'}
	{l s='Lorem Ipsum is simply dummy text of the printing and typesetting.' mod='blocknewsletter'}
	{l s='SALE UPTO' mod='blocknewsletter'}
	{l s='30%' mod='blocknewsletter'}
	{l s='On your next purchase!' mod='blocknewsletter'}
</div>
<!-- /Block Newsletter module-->
{strip}
{if isset($msg) && $msg}
