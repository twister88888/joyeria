...
<ul class="footer_links clearfix">
	<li>
		...
		<span><i class="fa fa-chevron-left"></i> {l s='Back to Your Account' mod='referralprogram'}</span></a>
	</li>
	<li><a class="btn btn-default button button-small" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{l s='Home' mod='referralprogram'}"><span><i class="fa fa-chevron-left"></i>{l s='Home' mod='referralprogram'}</span></a></li>
</ul>
