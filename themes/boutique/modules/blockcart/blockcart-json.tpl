...
{if isset($themeSetting.imagehome)}
	{assign var='home_img_type' value=$themeSetting.imagecart.type}
{else}
...
{assign var='productAttributeId' value=$product.id_product_attribute}
	...
	{ldelim}
		...
		"image": {$link->getImageLink($product.link_rewrite, $product.id_image, $home_img_type)|json_encode},
		"image_cart": {$link->getImageLink($product.link_rewrite, $product.id_image, $cart_img_type)|json_encode},
