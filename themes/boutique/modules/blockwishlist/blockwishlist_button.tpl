...
{else}
	<a class="addToWishlist wishlistProd_{$product.id_product|intval} wishlist" href="#" data-rel="{$product.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1); return false;">
